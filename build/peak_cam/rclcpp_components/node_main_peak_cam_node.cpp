...
#define NODE_MAIN_LOGGER_NAME "peak_cam_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpeak_cam.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<peak_cam::PeakCamNode>";
